...
#define MAXdouble  2147483647


#define PRECESION	 40
#define SEGMENTNUM 2*PRECESION

#define COLORFACE 0
#define USERAINBOW 1

#define NODEBUG 0
#define CHECKVISIBILITY 1

const double f_color_boundary=0.10;
const double p_color_boundary=90;
const double bandwidth=0.4;

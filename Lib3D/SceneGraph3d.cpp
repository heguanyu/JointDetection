...
// RemoveAll
//********************************************
void CSceneGraph3d::RemoveAll()
{
	m_ArrayObject3d.RemoveAll();
}
...
// glDraw
//********************************************
void CSceneGraph3d::glDraw(int DEBUGMODE)
{
	if(!m_ListDone)
		glBuildList();
...
// glDraw
//********************************************
void CSceneGraph3d::glDrawDirect(int DEBUGMODE)
{
	unsigned int size = m_ArrayObject3d.GetSize();
	for(unsigned int i=0; i<size; i++)
	{
